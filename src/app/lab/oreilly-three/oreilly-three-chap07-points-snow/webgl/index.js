...
export default function Canvas() {
  ...
  const texture1 = textureLoader.load('/lab/oreilly-three/images/texture/particle/snowflake1.png');
  const texture2 = textureLoader.load('/lab/oreilly-three/images/texture/particle/snowflake2.png');
  const texture3 = textureLoader.load('/lab/oreilly-three/images/texture/particle/snowflake3.png');
  const texture4 = textureLoader.load('/lab/oreilly-three/images/texture/particle/snowflake4.png');
